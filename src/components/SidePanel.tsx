...
import { Home, Rocket, Lock, Vault, DollarSign, FileText, ChevronDown, ChevronLeft, ChevronRight, Wallet, Network, AlertTriangle, Copy, ExternalLink, LogOut } from 'lucide-react';
