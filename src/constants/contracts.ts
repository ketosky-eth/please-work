...
export const CONTRACT_ADDRESSES = {
  SMART_VAULT: '0x0000000000000000000000000000000000000000' as `0x${string}`,
  IPFS_STORAGE: '0x0000000000000000000000000000000000000000' as `0x${string}`,
  BONDING_CURVE: '0x0000000000000000000000000000000000000000' as `0x${string}`,
  MEME_TOKEN_FACTORY: '0x0000000000000000000000000000000000000000' as `0x${string}`,
} as const;
